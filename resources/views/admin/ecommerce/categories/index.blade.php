...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-0 text-gray-800">Məhsul Kateqoriyaları</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <form action="{{ route('admin.product_categories.destroy', $category->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Silmək istədiyinizə əminsiniz?');">
                                    @csrf
                                    @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center text-muted py-4">Məhsul kateqoriyası yoxdur.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.product_categories.store') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Yeni Məhsul Kateqoriyası</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
