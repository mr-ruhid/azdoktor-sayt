                        ...
                        <div class="tab-pane fade {{ $index == 0 ? 'show active' : '' }}" id="main-content-{{ $lang->code }}">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" name="title[{{ $lang->code }}]"
                                       placeholder="Paylaşımın başlığı..."
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control editor" name="content[{{ $lang->code }}]" rows="15">{{ $post ? $post->getTranslation('content', $lang->code, false) : old('content.'.$lang->code) }}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
