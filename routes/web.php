...
// --- AJAX ROUTES (Lokalizasiyadan kənar) ---
...
Route::group(
    ...
    function() {
        ...
        // --- Checkout (Sifariş Rəsmiləşdirmə) ---
        Route::get('/checkout', [PublicController::class, 'checkout'])->name('checkout');
        Route::post('/checkout', [PublicController::class, 'placeOrder'])->name('checkout.submit');
        ...
        // --- Dinamik Səhifələr (Ən sonda olmalıdır) ---
        Route::get('/page/{slug}', [PublicController::class, 'page'])->name('page.show');


        // ====================================================
        // AUTH ROUTES (Giriş/Qeydiyyat)
        // ====================================================
        ...
        // ====================================================
        // USER & DOCTOR PANELS (Middleware: Auth)
        // ====================================================
        ...
        // ====================================================
        // ADMIN PANEL ROUTES (Middleware: Auth + Admin2FA)
        // ====================================================
